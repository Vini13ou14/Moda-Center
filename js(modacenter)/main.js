...
function showAccount(user){
  const profileLabel=user.profile==="comerciante"?"Comerciante":"Cliente";
  accountMessage.textContent="Bem-vindo(a), "+user.name+". Seu perfil de "+profileLabel+" está ativo.";
...
document.getElementById("registerForm").addEventListener("submit",event=>{
  ...
  users.push({id:Date.now(),name,email,password:form.get("password"),profile:form.get("profile")});
